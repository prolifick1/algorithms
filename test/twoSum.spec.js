...
describe('twoSum()', () => {
  ...
  it('Test Case #2', () => {
    expect(twoSum([4, 6, 1], 5)).to.eql([0, 2]);
  });

  it('Test Case #3', () => {
    expect(twoSum([4, 6, 1, -3], 3)).to.eql([1, 3]);
  });

  it('Test Case #4', () => {
    expect(twoSum([3, 5, -4, 8, 11, 1, -1, 6], 10)).to.eql([4, 6]);
  });
  ...
  it('Test Case #8', () => {
    expect(twoSum([-21, 301, 12, 4, 65, 56, 210, 356, 9, -47], 163)).to.eql([6, 9]);
  });
